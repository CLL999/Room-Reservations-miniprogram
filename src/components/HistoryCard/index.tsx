            ...
            <View className=' bg-white rounded-2xl w-70 mx-auto min-h-75 shadow-2xl'>
                ...
                <View className=' w-60 min-h-60 mx-auto'>
                    ...
                    <View className='w-full '>
                        <View className=' h-3'></View>
                        <View className=' font-medium text-lg h-7 w-full truncate'>{`申请人姓名：${props.name}`}</View>
                        <View className=' font-medium text-lg h-7 w-full truncate'>{`申请人学号：${props.studentId}`}</View>
                        ...
                        <View className=' font-medium text-lg h-7 w-full truncate'>{`负责老师： ${props.teacherName}`}</View>
